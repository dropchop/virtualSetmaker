"""Emit an Unreal Engine 5.6 Python script from an IR :class:`~virtualsetmaker.ir.Scene`.
...
try:
    unreal  # noqa: B018  (defined when running inside the editor)
except NameError:
    raise SystemExit(
...
def build_script(scene: Scene) -> str:
    ...
    header = (
        "# Auto-generated by virtualSetmaker. Run INSIDE the Unreal 5.6 editor:\n"
